  ...
  return (
    <div className="min-h-screen bg-[#F7F8F3] text-[#123026]">
      ...
      <section className="bg-[#EAF5EE] px-6 py-20 md:px-12 lg:px-20">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <p className="mb-3 text-sm font-semibold uppercase tracking-[0.2em] text-[#1F6B4A]">UN Sustainable Development Goals</p>
            <h2 className="text-3xl font-bold md:text-5xl">SOPHROSYNE & the SDGs</h2>
            <p className="mx-auto mt-5 max-w-3xl text-lg leading-8 text-[#53675D]">Το SOPHROSYNE ευθυγραμμίζεται με τους Στόχους Βιώσιμης Ανάπτυξης του ΟΗΕ, προωθώντας πιο βιώσιμες πόλεις, υπεύθυνη κατανάλωση και δράση για το κλίμα.</p>
          </div>
          <div className="grid gap-6 lg:grid-cols-3">
            {sdgs.map((sdg, idx) => (
      ...
      <section className="bg-white px-6 py-20 md:px-12 lg:px-20">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Button className="rounded-2xl bg-[#1F6B4A] px-8 py-6 text-base text-white hover:bg-[#18573C]">Join the Movement</Button>
            <Button variant="outline" className="rounded-2xl border-[#1F6B4A]/30 px-8 py-6 text-base">Download App</Button>
          </div>
        </div>
      </section>
    </div>
